...
%global pypi_name azure-cognitiveservices-vision-face
...
BuildRequires:  python3dist(azure-cognitiveservices-vision-nspkg)
...
Face Client Library.This package has been tested with Python 2.7, 3.5, 3.6 and
3.7.For a more complete set of Azure libraries, see the azure < bundle
package.For code examples, see Cognitive Services Face < on docs.microsoft.com.
