...
%global pypi_name azure-mgmt-servermanager
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Server Manager
...
%{python3_sitelib}/azure_mgmt_servermanager-%{version}-py?.?.egg-info
