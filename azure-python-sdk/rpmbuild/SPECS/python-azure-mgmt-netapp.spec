...
%global pypi_name azure-mgmt-netapp
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure NetApp Files
...
%{python3_sitelib}/azure_mgmt_netapp-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 0.8.0-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 0.8.0-1
- Initial package.