...
%global pypi_name azure-mgmt-hybridcompute
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Hybrid Compute
...
%{python3_sitelib}/azure_mgmt_hybridcompute-%{version}-py?.?.egg-info
