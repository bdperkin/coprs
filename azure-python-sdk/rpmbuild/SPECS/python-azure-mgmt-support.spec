...
%global pypi_name azure-mgmt-support
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Support Management
...
%{python3_sitelib}/azure_mgmt_support-%{version}-py?.?.egg-info
