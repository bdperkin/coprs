...
%global pypi_name azure-mgmt-resourcegraph
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Resource Graph
...
%{python3_sitelib}/azure_mgmt_resourcegraph-%{version}-py?.?.egg-info
