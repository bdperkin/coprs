...
%global pypi_name azure-cognitiveservices-formrecognizer

Name:           python-%{pypi_name}
Version:        0.1.0
Release:        1%{?dist}
Summary:        Microsoft Azure Cognitive Services Form Recognizer Client Library for Python
...
Form Recognizer Client Library.This package has been tested with Python 2.7,
3.4, 3.5, 3.6 and 3.7.For a more complete set of Azure libraries, see the azure
< bundle package.For code examples, see Cognitive Services Form Recognizer < on
...
%{python3_sitelib}/azure_cognitiveservices_formrecognizer-%{version}-py?.?.egg-info
