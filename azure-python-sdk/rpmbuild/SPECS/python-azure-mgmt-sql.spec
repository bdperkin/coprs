...
%description
 Microsoft Azure SDK for PythonThis is the Microsoft Azure SQL Management
...
code examples, see [SQL Management]( on docs.microsoft.com. Provide FeedbackIf
you encounter any bugs or have suggestions, please file an issue in the
[Issues](...
...
%{python3_sitelib}/azure_mgmt_sql-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 0.17.0-1
- Upgrade to version 0.17.0.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 0.16.0-1
- Initial package.