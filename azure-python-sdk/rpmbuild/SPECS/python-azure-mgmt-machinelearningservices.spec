...
%global pypi_name azure-mgmt-machinelearningservices

Name:           python-%{pypi_name}
Version:        0.1.0
Release:        1%{?dist}
Summary:        Microsoft Azure Machine Learning Services Management Client Library for Python
...
Services Management Client Library.Azure Resource Manager (ARM) is the next
generation of management APIs that replace the old Azure Service Management
(ASM).This package has been tested with Python 2.7, 3.5, 3.6 and 3.7.For the
...
%{python3_sitelib}/azure_mgmt_machinelearningservices-%{version}-py?.?.egg-info
