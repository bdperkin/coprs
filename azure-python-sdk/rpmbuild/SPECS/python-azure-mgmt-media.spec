...
%global pypi_name azure-mgmt-media
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Media Services
...
%{python3_sitelib}/azure_mgmt_media-%{version}-py?.?.egg-info
