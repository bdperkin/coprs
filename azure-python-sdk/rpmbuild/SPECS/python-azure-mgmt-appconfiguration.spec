...
%global pypi_name azure-mgmt-appconfiguration
...
%description
 Microsoft Azure SDK for PythonThis is the Microsoft Azure App Configuration
...
repo]( For code examples, see [App Configuration Management]( on
...
%{python3_sitelib}/azure_mgmt_appconfiguration-%{version}-py?.?.egg-info
