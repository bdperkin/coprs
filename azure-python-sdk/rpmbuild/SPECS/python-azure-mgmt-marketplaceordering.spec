...
%global pypi_name azure-mgmt-marketplaceordering
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Market Place
Ordering Client Library.Azure Resource Manager (ARM) is the next generation of
...
%{python3_sitelib}/azure_mgmt_marketplaceordering-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 0.2.1-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 0.2.1-1
- Initial package.