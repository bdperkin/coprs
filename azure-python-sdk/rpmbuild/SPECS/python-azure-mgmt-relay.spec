...
%global pypi_name azure-mgmt-relay
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Relay Client
...
%{python3_sitelib}/azure_mgmt_relay-%{version}-py?.?.egg-info
