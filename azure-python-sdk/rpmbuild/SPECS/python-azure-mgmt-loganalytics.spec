...
%global pypi_name azure-mgmt-loganalytics
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Log Analytics
...
%{python3_sitelib}/azure_mgmt_loganalytics-%{version}-py?.?.egg-info
