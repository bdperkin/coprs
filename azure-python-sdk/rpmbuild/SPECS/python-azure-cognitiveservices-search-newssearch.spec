...
%global pypi_name azure-cognitiveservices-search-newssearch
...
News Search Client Library.This package has been tested with Python 2.7, 3.5,
3.6, 3.7 and 3.8.For a more complete set of Azure libraries, see the azure <
bundle package.For code examples, see Cognitive Services News Search < on
...
%{python3_sitelib}/azure_cognitiveservices_search_newssearch-%{version}-py?.?.egg-info
