...
%global pypi_name azure-mgmt-advisor
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Advisor Client
...
%{python3_sitelib}/azure_mgmt_advisor-%{version}-py?.?.egg-info
