...
%global pypi_name azure-mgmt-servicebus
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Service Bus
...
%{python3_sitelib}/azure_mgmt_servicebus-%{version}-py?.?.egg-info
