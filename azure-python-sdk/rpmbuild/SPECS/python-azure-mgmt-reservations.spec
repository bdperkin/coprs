...
%global pypi_name azure-mgmt-reservations
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Reservations Client
...
tested with Python 2.7, 3.5, 3.6, 3.7 and 3.8.For the older Azure Service
...
%{python3_sitelib}/azure_mgmt_reservations-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 0.7.0-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 0.7.0-1
- Initial package.