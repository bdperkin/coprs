...
%global pypi_name azure-mgmt-edgegateway

Name:           python-%{pypi_name}
Version:        0.1.0
Release:        1%{?dist}
Summary:        Microsoft Azure Data Box Edge / Data Box Gateway Client Library for Python
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Data Box Edge / Data
Box Gateway Client Library.Azure Resource Manager (ARM) is the next generation
...
%{python3_sitelib}/azure_mgmt_edgegateway-%{version}-py?.?.egg-info
