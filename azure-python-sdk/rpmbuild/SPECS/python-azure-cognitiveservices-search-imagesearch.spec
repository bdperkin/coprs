...
%global pypi_name azure-cognitiveservices-search-imagesearch
...
Image Search Client Library.This package has been tested with Python 2.7, 3.5,
3.6 and 3.7.For a more complete set of Azure libraries, see the azure < bundle
package.For code examples, see Cognitive Services Image Search < on
...
%{python3_sitelib}/azure_cognitiveservices_search_imagesearch-%{version}-py?.?.egg-info
