...
%global pypi_name azure-mgmt-policyinsights
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Policy Insights
...
%{python3_sitelib}/azure_mgmt_policyinsights-%{version}-py?.?.egg-info
