...
%global pypi_name azure-mgmt-peering
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Peering Management
...
%{python3_sitelib}/azure_mgmt_peering-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 0.1.0rc2-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 0.1.0rc2-1
- Initial package.