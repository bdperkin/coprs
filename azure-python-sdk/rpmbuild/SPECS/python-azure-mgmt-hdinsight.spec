...
%global pypi_name azure-mgmt-hdinsight
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure HDInsight Management
...
%{python3_sitelib}/azure_mgmt_hdinsight-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 1.4.0-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 1.4.0-1
- Initial package.