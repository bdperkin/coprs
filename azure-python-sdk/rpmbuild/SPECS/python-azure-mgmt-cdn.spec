...
%global pypi_name azure-mgmt-cdn
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure CDN Management
...
%{python3_sitelib}/azure_mgmt_cdn-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 4.1.0rc1-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 4.1.0rc1-1
- Initial package.