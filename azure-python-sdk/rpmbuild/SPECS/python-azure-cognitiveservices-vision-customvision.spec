...
%global pypi_name azure-cognitiveservices-vision-customvision
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Custom Vision Client
...
examples, see Custom Vision < on docs.microsoft.com. Provide Feedback If you
...
%{python3_sitelib}/azure_cognitiveservices_vision_customvision-%{version}-py?.?.egg-info
