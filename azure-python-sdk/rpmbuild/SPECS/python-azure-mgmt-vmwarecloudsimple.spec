...
%global pypi_name azure-mgmt-vmwarecloudsimple
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure MyService Management
...
%{python3_sitelib}/azure_mgmt_vmwarecloudsimple-%{version}-py?.?.egg-info
