...
%global pypi_name azure-mgmt-privatedns
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure DNS Private Zones
...
%{python3_sitelib}/azure_mgmt_privatedns-%{version}-py?.?.egg-info
