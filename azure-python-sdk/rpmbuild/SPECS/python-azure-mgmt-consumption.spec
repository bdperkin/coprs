...
%global pypi_name azure-mgmt-consumption
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Consumption Client
...
%{python3_sitelib}/azure_mgmt_consumption-%{version}-py?.?.egg-info
