...
%global pypi_name azure-mgmt-iotcentral
...
%description
 Microsoft Azure SDK for PythonThis is the Microsoft Azure IoTCentral
...
repo]( For code examples, see [IoTCentral Management]( on docs.microsoft.com.
Provide FeedbackIf you encounter any bugs or have suggestions, please file an
issue in the...
...
%{python3_sitelib}/azure_mgmt_iotcentral-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 3.0.0-1
