...
%global pypi_name azure-mgmt-sqlvirtualmachine
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure SQL Virtual Machine
...
%{python3_sitelib}/azure_mgmt_sqlvirtualmachine-%{version}-py?.?.egg-info
