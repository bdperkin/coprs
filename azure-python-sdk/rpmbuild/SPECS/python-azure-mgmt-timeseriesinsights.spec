...
%global pypi_name azure-mgmt-timeseriesinsights
...
%description
 Microsoft Azure SDK for PythonThis is the Microsoft Azure TimeSeriesInsights
Management Client Azure Resource Manager (ARM) is the next generation of
...
%{python3_sitelib}/azure_mgmt_timeseriesinsights-%{version}-py?.?.egg-info
