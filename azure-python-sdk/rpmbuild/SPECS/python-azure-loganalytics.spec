...
%global pypi_name azure-loganalytics
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Log Analytics Client
Library.This package has been tested with Python 2.7, 3.4, 3.5 and 3.6.For a
more complete set of Azure libraries, see the azure < bundle package.
...
Requires:       python3dist(msrest) < 2.0.0
Requires:       python3dist(msrest) >= 0.4.29
...
%{python3_sitelib}/azure_loganalytics-%{version}-py?.?.egg-info
