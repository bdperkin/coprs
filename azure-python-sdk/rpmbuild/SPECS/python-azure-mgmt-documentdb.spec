...
%global pypi_name azure-mgmt-documentdb
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure DocumentDB
...
package has been tested with Python 2.7, 3.3, 3.4, 3.5 and 3.6.For the older
...
Requires:       python3dist(msrestazure) >= 0.4.7
...
%{python3_sitelib}/azure_mgmt_documentdb-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 0.1.3-2
- Rebuilt.
