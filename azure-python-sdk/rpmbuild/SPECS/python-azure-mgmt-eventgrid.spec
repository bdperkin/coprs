...
%global pypi_name azure-mgmt-eventgrid
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure EventGrid Management
...
%{python3_sitelib}/azure_mgmt_eventgrid-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 3.0.0rc4-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 3.0.0rc4-1
- Initial package.