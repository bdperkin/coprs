...
%description
 Microsoft Azure SDK for PythonThis is the Microsoft Azure Compute Management
...
code examples, see [Compute Management]( on docs.microsoft.com. Provide
...
%{python3_sitelib}/azure_mgmt_compute-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 11.1.0-1
- Upgrade to version 11.1.0.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 10.0.0-1
- Initial package.