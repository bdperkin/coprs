...
%global pypi_name azure-mgmt-databox
...
%description
 Microsoft Azure SDK for PythonThis is the Microsoft Azure DataBox Management
...
code examples, see [DataBox Management]( on docs.microsoft.com. Provide
...
%{python3_sitelib}/azure_mgmt_databox-%{version}-py?.?.egg-info
