...
%global pypi_name azure-mgmt-automation
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Automation Client
...
%{python3_sitelib}/azure_mgmt_automation-%{version}-py?.?.egg-info
