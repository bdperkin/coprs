...
%global pypi_name azure-eventhub-checkpointstoreblob-aio
...
BuildRequires:  python3dist(aiohttp) < 4.0
...
Requires:       python3dist(aiohttp) < 4.0
...
%{python3_sitelib}/azure_eventhub_checkpointstoreblob_aio-%{version}-py?.?.egg-info
