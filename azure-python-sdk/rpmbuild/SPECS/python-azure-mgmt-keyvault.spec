...
%description
 Microsoft Azure SDK for PythonThis is the Microsoft Azure Key Vault Management
...
code examples, see [Key Vault Management]( on docs.microsoft.com. Provide
...
%{python3_sitelib}/azure_mgmt_keyvault-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 2.1.1-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 2.1.1-1
- Initial package.