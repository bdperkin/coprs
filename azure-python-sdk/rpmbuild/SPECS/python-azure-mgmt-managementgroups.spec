...
%global pypi_name azure-mgmt-managementgroups
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Management Groups
...
%{python3_sitelib}/azure_mgmt_managementgroups-%{version}-py?.?.egg-info
