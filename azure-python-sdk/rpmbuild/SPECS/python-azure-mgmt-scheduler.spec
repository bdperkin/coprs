...
%global pypi_name azure-mgmt-scheduler
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Scheduler Management
...
%{python3_sitelib}/azure_mgmt_scheduler-%{version}-py?.?.egg-info
