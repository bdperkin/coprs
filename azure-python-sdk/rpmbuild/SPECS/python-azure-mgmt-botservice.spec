...
%global pypi_name azure-mgmt-botservice
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Bot Service Client
...
%{python3_sitelib}/azure_mgmt_botservice-%{version}-py?.?.egg-info
