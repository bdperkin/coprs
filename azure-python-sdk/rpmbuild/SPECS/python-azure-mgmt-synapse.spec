...
%global pypi_name azure-mgmt-synapse
...
%description
 Microsoft Azure SDK for PythonThis is the Microsoft Azure Synapse Management
...
code examples, see [Synapse Management]( on docs.microsoft.com. Provide
...
%{python3_sitelib}/azure_mgmt_synapse-%{version}-py?.?.egg-info
