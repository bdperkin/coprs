...
%global pypi_name azure-mgmt-recoveryservicesbackup
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Recovery Services
Backup Management Client Library.Azure Resource Manager (ARM) is the next
generation of management APIs that replace the old Azure Service Management
(ASM).This package has been tested with Python 2.7, 3.5, 3.6, 3.7 and 3.8.For
the older Azure Service Management (ASM) libraries, see azure-
...
%{python3_sitelib}/azure_mgmt_recoveryservicesbackup-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 0.6.0-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 0.6.0-1
- Initial package.