...
%description
 Microsoft Azure SDK for PythonThis is the Microsoft Azure Container Service
...
%{python3_sitelib}/azure_mgmt_containerservice-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 8.3.0-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 8.3.0-1
- Initial package.