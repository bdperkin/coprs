...
%global pypi_name azure-applicationinsights
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Application Insights
...
Requires:       python3dist(msrest) >= 0.5.4
...
%{python3_sitelib}/azure_applicationinsights-%{version}-py?.?.egg-info
