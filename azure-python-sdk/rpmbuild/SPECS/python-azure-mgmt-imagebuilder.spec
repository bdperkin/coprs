...
%global pypi_name azure-mgmt-imagebuilder
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Image Builder Client
...
tested with Python 2.7, 3.5, 3.6 and 3.7.For the older Azure Service Management
...
%{python3_sitelib}/azure_mgmt_imagebuilder-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 0.3.0-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 0.3.0-1
- Initial package.