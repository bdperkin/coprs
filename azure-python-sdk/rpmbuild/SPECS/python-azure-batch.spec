...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Batch Client
...
%{python3_sitelib}/azure_batch-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 8.0.0-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 8.0.0-1
- Initial package.