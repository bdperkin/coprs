...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Graph RBAC Client
...
examples, see Graph RBAC < on docs.microsoft.com. Provide Feedback If you
...
%{python3_sitelib}/azure_graphrbac-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 0.61.1-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 0.61.1-1
- Initial package.