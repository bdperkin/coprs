...
%global pypi_name azure-mgmt-azurestack

Name:           python-%{pypi_name}
Version:        0.1.0
Release:        2%{?dist}
Summary:        Microsoft Azure AzureStack Management Client Library for Python
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure AzureStack
...
%{python3_sitelib}/azure_mgmt_azurestack-%{version}-py?.?.egg-info
