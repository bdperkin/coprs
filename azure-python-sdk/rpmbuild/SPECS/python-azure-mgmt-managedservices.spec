...
%global pypi_name azure-mgmt-managedservices
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Managed Services
...
%{python3_sitelib}/azure_mgmt_managedservices-%{version}-py?.?.egg-info
