...
%global pypi_name azure-mgmt-datalake-store
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Data Lake Store
...
%{python3_sitelib}/azure_mgmt_datalake_store-%{version}-py?.?.egg-info
