...
%global pypi_name azure-mgmt-powerbidedicated
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure PowerBIDedicated
...
%{python3_sitelib}/azure_mgmt_powerbidedicated-%{version}-py?.?.egg-info
