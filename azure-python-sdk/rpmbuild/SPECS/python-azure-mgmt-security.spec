...
%global pypi_name azure-mgmt-security
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Security Center
...
%{python3_sitelib}/azure_mgmt_security-%{version}-py?.?.egg-info
