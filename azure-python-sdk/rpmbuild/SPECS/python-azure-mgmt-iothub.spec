...
%global pypi_name azure-mgmt-iothub
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure IoTHub Management
...
%{python3_sitelib}/azure_mgmt_iothub-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 0.10.0-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 0.10.0-1
- Initial package.