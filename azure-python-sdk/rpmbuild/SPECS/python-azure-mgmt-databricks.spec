...
%global pypi_name azure-mgmt-databricks

Name:           python-%{pypi_name}
Version:        0.1.0
Release:        2%{?dist}
Summary:        Microsoft Azure Databricks Management Client Library for Python
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Databricks
...
%{python3_sitelib}/azure_mgmt_databricks-%{version}-py?.?.egg-info
