...
%global pypi_name azure-mgmt-redis
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Redis Cache
...
%{python3_sitelib}/azure_mgmt_redis-%{version}-py?.?.egg-info

%changelog
* Wed Mar 11 2020 Brandon Perkins <bperkins@redhat.com> - 7.0.0rc1-2
- Rebuilt.

* Sun Mar 01 2020 Brandon Perkins <bperkins@redhat.com> - 7.0.0rc1-1
- Initial package.