...
%global pypi_name azure-mgmt-msi
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure MSI Management
...
%{python3_sitelib}/azure_mgmt_msi-%{version}-py?.?.egg-info
