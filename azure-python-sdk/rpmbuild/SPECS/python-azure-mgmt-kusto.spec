...
%global pypi_name azure-mgmt-kusto
...
%description
Microsoft Azure SDK for Python This is the Microsoft Azure Kusto Management
...
%{python3_sitelib}/azure_mgmt_kusto-%{version}-py?.?.egg-info
