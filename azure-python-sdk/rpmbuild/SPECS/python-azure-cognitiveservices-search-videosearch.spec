...
%global pypi_name azure-cognitiveservices-search-videosearch

Name:           python-%{pypi_name}
Version:        2.0.0
Release:        2%{?dist}
Summary:        Microsoft Azure Cognitive Services Video Search Client Library for Python
...
BuildRequires:  python3dist(azure-cognitiveservices-search-nspkg)
...
Video Search Client Library.This package has been tested with Python 2.7, 3.5,
3.6, 3.7 and 3.8.For a more complete set of Azure libraries, see the azure <
bundle package.For code examples, see Cognitive Services Video Search < on
...
%{python3_sitelib}/azure_cognitiveservices_search_videosearch-%{version}-py?.?.egg-info
