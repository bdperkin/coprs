...
%global pypi_name azure-cognitiveservices-language-textanalytics
...
Text Analytics Client Library.This package has been tested with Python 2.7,
3.4, 3.5, 3.6 and 3.7.For a more complete set of Azure libraries, see the azure
< bundle package.For code examples, see Cognitive Services Text Analytics < on
...
%{python3_sitelib}/azure_cognitiveservices_language_textanalytics-%{version}-py?.?.egg-info
