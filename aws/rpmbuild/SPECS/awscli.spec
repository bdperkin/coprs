...
%global botocore_version        1.15.8
...
Requires:       python3-s3transfer >= 0.3.3
...
Requires:       python2-s3transfer >= 0.3.3
...
%changelog
* Mon Oct 21 2019 James Hogarth <james.hogarth@gmail.com> - 1.18.8-2
- Fix changelog syntax
- Remove unused patchfile

* Sat Oct 19 2019 David Duncan <davdunc@amazon.com> - 1.18.8-1
- Merge changes from 1.18.8 release.
