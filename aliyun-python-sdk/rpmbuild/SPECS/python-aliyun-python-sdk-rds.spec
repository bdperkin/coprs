...
%global pypi_name aliyun-python-sdk-rds
...
%description
 aliyun-python-sdk-rds .. This is the rds module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkrds
%{python2_sitelib}/aliyun_python_sdk_rds-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkrds
%{python3_sitelib}/aliyun_python_sdk_rds-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 2.4.4-1
- Initial package.