...
%global pypi_name aliyun-python-sdk-hsm

Name:           python-%{pypi_name}
Version:        1.0.1
Release:        1%{?dist}
Summary:        The hsm module of Aliyun Python sdk
...
%description
aliyun-python-sdk-hsm This is the hsm module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkhsm
%{python2_sitelib}/aliyun_python_sdk_hsm-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkhsm
%{python3_sitelib}/aliyun_python_sdk_hsm-%{version}-py?.?.egg-info
