...
%global pypi_name aliyun-python-sdk-faas
...
%description
 aliyun-python-sdk-faas .. This is the faas module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkfaas
%{python2_sitelib}/aliyun_python_sdk_faas-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkfaas
%{python3_sitelib}/aliyun_python_sdk_faas-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 2.7.5-1
- Initial package.