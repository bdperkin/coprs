...
%global pypi_name aliyun-python-sdk-live
...
%description
 aliyun-python-sdk-live .. This is the live module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdklive
%{python2_sitelib}/aliyun_python_sdk_live-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdklive
%{python3_sitelib}/aliyun_python_sdk_live-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 3.8.0-1
- Initial package.