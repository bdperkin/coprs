...
%global pypi_name aliyun-python-sdk-oos
...
%description
 aliyun-python-sdk-oos .. This is the oos module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkoos
%{python2_sitelib}/aliyun_python_sdk_oos-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkoos
%{python3_sitelib}/aliyun_python_sdk_oos-%{version}-py?.?.egg-info

%changelog
* Fri Feb 21 2020 mockbuilder - 1.1.0-1
- Initial package.