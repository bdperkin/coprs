...
%global pypi_name aliyun-python-sdk-iqa

Name:           python-%{pypi_name}
Version:        1.0.0
Release:        1%{?dist}
Summary:        The iqa module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-iqa .. This is the iqa module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkiqa
%{python2_sitelib}/aliyun_python_sdk_iqa-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkiqa
%{python3_sitelib}/aliyun_python_sdk_iqa-%{version}-py?.?.egg-info
