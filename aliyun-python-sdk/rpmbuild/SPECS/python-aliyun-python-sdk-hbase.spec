...
%global pypi_name aliyun-python-sdk-hbase

Name:           python-%{pypi_name}
Version:        2.2.0
Release:        1%{?dist}
Summary:        The hbase module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-hbase .. This is the hbase module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkhbase
%{python2_sitelib}/aliyun_python_sdk_hbase-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkhbase
%{python3_sitelib}/aliyun_python_sdk_hbase-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 2.2.0-1
- Initial package.