...
%global pypi_name aliyun-python-sdk-unimkt

Name:           python-%{pypi_name}
Version:        1.0.0
Release:        1%{?dist}
Summary:        The unimkt module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-unimkt .. This is the unimkt module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkunimkt
%{python2_sitelib}/aliyun_python_sdk_unimkt-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkunimkt
%{python3_sitelib}/aliyun_python_sdk_unimkt-%{version}-py?.?.egg-info
