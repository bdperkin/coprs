...
%global pypi_name aliyun-python-sdk-vpc
...
%description
 aliyun-python-sdk-vpc .. This is the vpc module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkvpc
%{python2_sitelib}/aliyun_python_sdk_vpc-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkvpc
%{python3_sitelib}/aliyun_python_sdk_vpc-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 3.0.8-1
- Initial package.