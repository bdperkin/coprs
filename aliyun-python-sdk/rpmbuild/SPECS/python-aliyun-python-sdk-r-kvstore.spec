...
%global pypi_name aliyun-python-sdk-r-kvstore
...
%description
 aliyun-python-sdk-r-kvstore .. This is the r-kvstore module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkr_kvstore
%{python2_sitelib}/aliyun_python_sdk_r_kvstore-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkr_kvstore
%{python3_sitelib}/aliyun_python_sdk_r_kvstore-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 2.1.4-1
- Initial package.