...
%global pypi_name aliyun-python-sdk-imageaudit

Name:           python-%{pypi_name}
Version:        1.0.1
Release:        1%{?dist}
Summary:        The imageaudit module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-imageaudit .. This is the imageaudit module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkimageaudit
%{python2_sitelib}/aliyun_python_sdk_imageaudit-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkimageaudit
%{python3_sitelib}/aliyun_python_sdk_imageaudit-%{version}-py?.?.egg-info
