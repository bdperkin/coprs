...
%global pypi_name aliyun-python-sdk-aas
...
%description
 aliyun-python-sdk-aas .. This is the aas module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkaas
%{python2_sitelib}/aliyun_python_sdk_aas-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkaas
%{python3_sitelib}/aliyun_python_sdk_aas-%{version}-py?.?.egg-info
