...
%global pypi_name aliyun-python-sdk-sae
...
%description
 aliyun-python-sdk-sae .. This is the sae module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdksae
%{python2_sitelib}/aliyun_python_sdk_sae-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdksae
%{python3_sitelib}/aliyun_python_sdk_sae-%{version}-py?.?.egg-info
