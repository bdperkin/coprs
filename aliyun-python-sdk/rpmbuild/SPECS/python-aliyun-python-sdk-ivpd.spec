...
%global pypi_name aliyun-python-sdk-ivpd

Name:           python-%{pypi_name}
Version:        1.0.0
Release:        1%{?dist}
Summary:        The ivpd module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-ivpd .. This is the ivpd module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkivpd
%{python2_sitelib}/aliyun_python_sdk_ivpd-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkivpd
%{python3_sitelib}/aliyun_python_sdk_ivpd-%{version}-py?.?.egg-info
