...
%global pypi_name aliyun-python-sdk-dcdn
...
%description
 aliyun-python-sdk-dcdn .. This is the dcdn module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkdcdn
%{python2_sitelib}/aliyun_python_sdk_dcdn-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkdcdn
%{python3_sitelib}/aliyun_python_sdk_dcdn-%{version}-py?.?.egg-info
