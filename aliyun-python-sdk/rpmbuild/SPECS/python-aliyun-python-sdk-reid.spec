...
%global pypi_name aliyun-python-sdk-reid

Name:           python-%{pypi_name}
Version:        1.1.1
Release:        1%{?dist}
Summary:        The reid module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-reid .. This is the reid module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkreid
%{python2_sitelib}/aliyun_python_sdk_reid-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkreid
%{python3_sitelib}/aliyun_python_sdk_reid-%{version}-py?.?.egg-info
