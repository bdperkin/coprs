...
%global pypi_name aliyun-python-sdk-nlp-automl
...
%description
 aliyun-python-sdk-nlp-automl .. This is the nlp-automl module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdknlp_automl
%{python2_sitelib}/aliyun_python_sdk_nlp_automl-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdknlp_automl
%{python3_sitelib}/aliyun_python_sdk_nlp_automl-%{version}-py?.?.egg-info
