...
%global pypi_name aliyun-python-sdk-saf

Name:           python-%{pypi_name}
Version:        1.0.1
Release:        1%{?dist}
Summary:        The saf module of Aliyun Python sdk
...
%description
aliyun-python-sdk-saf This is the saf module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdksaf
%{python2_sitelib}/aliyun_python_sdk_saf-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdksaf
%{python3_sitelib}/aliyun_python_sdk_saf-%{version}-py?.?.egg-info
