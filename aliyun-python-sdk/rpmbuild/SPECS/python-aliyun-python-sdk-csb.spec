...
%global pypi_name aliyun-python-sdk-csb

Name:           python-%{pypi_name}
Version:        1.2.1
Release:        1%{?dist}
Summary:        The csb module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-csb .. This is the csb module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkcsb
%{python2_sitelib}/aliyun_python_sdk_csb-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkcsb
%{python3_sitelib}/aliyun_python_sdk_csb-%{version}-py?.?.egg-info
