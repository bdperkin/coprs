...
%global pypi_name aliyun-python-sdk-ehpc
...
%description
 aliyun-python-sdk-ehpc .. This is the ehpc module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkehpc
%{python2_sitelib}/aliyun_python_sdk_ehpc-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkehpc
%{python3_sitelib}/aliyun_python_sdk_ehpc-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 1.12.0-1
- Initial package.