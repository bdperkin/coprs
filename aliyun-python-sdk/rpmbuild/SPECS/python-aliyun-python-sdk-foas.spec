...
%global pypi_name aliyun-python-sdk-foas

Name:           python-%{pypi_name}
Version:        2.3.3
Release:        1%{?dist}
Summary:        The foas module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-foas .. This is the foas module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkfoas
%{python2_sitelib}/aliyun_python_sdk_foas-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkfoas
%{python3_sitelib}/aliyun_python_sdk_foas-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 2.3.3-1
- Initial package.