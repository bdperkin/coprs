...
%global pypi_name aliyun-python-sdk-vs

Name:           python-%{pypi_name}
Version:        1.7.0
Release:        1%{?dist}
Summary:        The vs module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-vs .. This is the vs module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkvs
%{python2_sitelib}/aliyun_python_sdk_vs-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkvs
%{python3_sitelib}/aliyun_python_sdk_vs-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 1.7.0-1
- Initial package.