...
%global pypi_name aliyun-python-sdk-nas

Name:           python-%{pypi_name}
Version:        3.6.0
Release:        1%{?dist}
Summary:        The nas module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-nas .. This is the nas module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdknas
%{python2_sitelib}/aliyun_python_sdk_nas-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdknas
%{python3_sitelib}/aliyun_python_sdk_nas-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 3.6.0-1
- Initial package.