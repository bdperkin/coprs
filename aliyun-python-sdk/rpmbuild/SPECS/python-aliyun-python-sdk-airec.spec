...
%global pypi_name aliyun-python-sdk-airec
...
%description
 aliyun-python-sdk-airec .. This is the airec module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkairec
%{python2_sitelib}/aliyun_python_sdk_airec-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkairec
%{python3_sitelib}/aliyun_python_sdk_airec-%{version}-py?.?.egg-info
