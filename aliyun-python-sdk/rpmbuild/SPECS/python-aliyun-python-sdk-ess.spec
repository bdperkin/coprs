...
%global pypi_name aliyun-python-sdk-ess
...
%description
aliyun-python-sdk-ess This is the ess module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkess
%{python2_sitelib}/aliyun_python_sdk_ess-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkess
%{python3_sitelib}/aliyun_python_sdk_ess-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 2.3.0-1
- Initial package.