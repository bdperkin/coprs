...
%global pypi_name aliyun-python-sdk-cms
...
%doc README.rst
%{python2_sitelib}/aliyunsdkcms
%{python2_sitelib}/aliyun_python_sdk_cms-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkcms
%{python3_sitelib}/aliyun_python_sdk_cms-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 7.0.10-1
- Initial package.