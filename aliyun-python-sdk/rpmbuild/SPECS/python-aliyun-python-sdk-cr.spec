...
%global pypi_name aliyun-python-sdk-cr

Name:           python-%{pypi_name}
Version:        3.0.1
Release:        1%{?dist}
Summary:        The cr module of Aliyun Python sdk
...
%description
aliyun-python-sdk-cr This is the cr module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkcr
%{python2_sitelib}/aliyun_python_sdk_cr-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkcr
%{python3_sitelib}/aliyun_python_sdk_cr-%{version}-py?.?.egg-info
