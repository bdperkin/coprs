...
%global pypi_name aliyun-python-sdk-drds
...
%description
 aliyun-python-sdk-drds .. This is the drds module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkdrds
%{python2_sitelib}/aliyun_python_sdk_drds-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkdrds
%{python3_sitelib}/aliyun_python_sdk_drds-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 4.1.0-1
- Initial package.