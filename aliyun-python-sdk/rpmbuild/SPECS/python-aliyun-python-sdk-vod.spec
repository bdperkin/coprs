...
%global pypi_name aliyun-python-sdk-vod
...
%description
 aliyun-python-sdk-vod .. This is the vod module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkvod
%{python2_sitelib}/aliyun_python_sdk_vod-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkvod
%{python3_sitelib}/aliyun_python_sdk_vod-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 2.15.8-1
- Initial package.