...
%global pypi_name aliyun-python-sdk-push
...
%description
 aliyun-python-sdk-push .. This is the push module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkpush
%{python2_sitelib}/aliyun_python_sdk_push-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkpush
%{python3_sitelib}/aliyun_python_sdk_push-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 3.13.0-1
- Initial package.