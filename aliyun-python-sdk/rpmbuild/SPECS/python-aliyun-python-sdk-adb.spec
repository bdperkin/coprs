...
%global pypi_name aliyun-python-sdk-adb
...
%description
 aliyun-python-sdk-adb .. This is the adb module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkadb
%{python2_sitelib}/aliyun_python_sdk_adb-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkadb
%{python3_sitelib}/aliyun_python_sdk_adb-%{version}-py?.?.egg-info
