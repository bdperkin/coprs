...
%global pypi_name aliyun-python-sdk-actiontrail

Name:           python-%{pypi_name}
Version:        2.0.1
Release:        1%{?dist}
Summary:        The actiontrail module of Aliyun Python sdk
...
%doc README.rst
%{python2_sitelib}/aliyunsdkactiontrail
%{python2_sitelib}/aliyun_python_sdk_actiontrail-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkactiontrail
%{python3_sitelib}/aliyun_python_sdk_actiontrail-%{version}-py?.?.egg-info
