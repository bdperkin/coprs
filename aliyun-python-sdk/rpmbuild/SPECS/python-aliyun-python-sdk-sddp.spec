...
%global pypi_name aliyun-python-sdk-sddp

Name:           python-%{pypi_name}
Version:        1.0.1
Release:        1%{?dist}
Summary:        The sddp module of Aliyun Python sdk
...
%description
aliyun-python-sdk-sddp This is the sddp module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdksddp
%{python2_sitelib}/aliyun_python_sdk_sddp-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdksddp
%{python3_sitelib}/aliyun_python_sdk_sddp-%{version}-py?.?.egg-info
