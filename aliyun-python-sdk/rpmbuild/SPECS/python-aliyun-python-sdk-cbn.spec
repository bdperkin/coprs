...
%global pypi_name aliyun-python-sdk-cbn
...
%description
aliyun-python-sdk-cbn This is the cbn module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkcbn
%{python2_sitelib}/aliyun_python_sdk_cbn-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkcbn
%{python3_sitelib}/aliyun_python_sdk_cbn-%{version}-py?.?.egg-info
