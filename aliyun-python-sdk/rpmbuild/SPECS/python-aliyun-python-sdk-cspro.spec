...
%global pypi_name aliyun-python-sdk-cspro

Name:           python-%{pypi_name}
Version:        1.3.9
Release:        1%{?dist}
Summary:        The cspro module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-cspro .. This is the cspro module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkcspro
%{python2_sitelib}/aliyun_python_sdk_cspro-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkcspro
%{python3_sitelib}/aliyun_python_sdk_cspro-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 1.3.9-1
- Initial package.