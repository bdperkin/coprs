...
%global pypi_name aliyun-python-sdk-edas
...
%description
 aliyun-python-sdk-edas .. This is the edas module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkedas
%{python2_sitelib}/aliyun_python_sdk_edas-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkedas
%{python3_sitelib}/aliyun_python_sdk_edas-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 2.53.4-1
- Initial package.