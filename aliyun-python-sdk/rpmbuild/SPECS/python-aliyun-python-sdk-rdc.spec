...
%global pypi_name aliyun-python-sdk-rdc

Name:           python-%{pypi_name}
Version:        1.1
Release:        1%{?dist}
Summary:        The rdc module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-rdc .. This is the rdc module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkrdc
%{python2_sitelib}/aliyun_python_sdk_rdc-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkrdc
%{python3_sitelib}/aliyun_python_sdk_rdc-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 1.1-1
- Initial package.