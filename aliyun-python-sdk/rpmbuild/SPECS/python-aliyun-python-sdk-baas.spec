...
%global pypi_name aliyun-python-sdk-baas

Name:           python-%{pypi_name}
Version:        1.0.0
Release:        1%{?dist}
Summary:        The baas module of Aliyun Python sdk
...
%description
aliyun-python-sdk-baas This is the baas module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkbaas
%{python2_sitelib}/aliyun_python_sdk_baas-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkbaas
%{python3_sitelib}/aliyun_python_sdk_baas-%{version}-py?.?.egg-info
