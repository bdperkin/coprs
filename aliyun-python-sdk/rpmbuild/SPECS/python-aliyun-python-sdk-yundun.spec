...
%global pypi_name aliyun-python-sdk-yundun
...
%description
aliyun-python-sdk-yundun This is the yundun module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkyundun
%{python2_sitelib}/aliyun_python_sdk_yundun-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkyundun
%{python3_sitelib}/aliyun_python_sdk_yundun-%{version}-py?.?.egg-info
