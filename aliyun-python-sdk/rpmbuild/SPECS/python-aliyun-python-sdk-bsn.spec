...
%global pypi_name aliyun-python-sdk-bsn
...
%description
aliyun-python-sdk-bsn This is the bsn module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkbsn
%{python2_sitelib}/aliyun_python_sdk_bsn-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkbsn
%{python3_sitelib}/aliyun_python_sdk_bsn-%{version}-py?.?.egg-info
