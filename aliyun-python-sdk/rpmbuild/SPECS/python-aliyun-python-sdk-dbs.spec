...
%global pypi_name aliyun-python-sdk-dbs
...
%description
 aliyun-python-sdk-dbs .. This is the dbs module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkdbs
%{python2_sitelib}/aliyun_python_sdk_dbs-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkdbs
%{python3_sitelib}/aliyun_python_sdk_dbs-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 1.0.20-1
- Initial package.