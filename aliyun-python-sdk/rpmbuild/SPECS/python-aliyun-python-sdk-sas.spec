...
%global pypi_name aliyun-python-sdk-sas

Name:           python-%{pypi_name}
Version:        1.0.3
Release:        1%{?dist}
Summary:        The sas module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-sas .. This is the sas module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdksas
%{python2_sitelib}/aliyun_python_sdk_sas-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdksas
%{python3_sitelib}/aliyun_python_sdk_sas-%{version}-py?.?.egg-info
