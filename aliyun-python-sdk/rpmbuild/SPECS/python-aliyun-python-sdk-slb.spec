...
%global pypi_name aliyun-python-sdk-slb
...
%description
 aliyun-python-sdk-slb .. This is the slb module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkslb
%{python2_sitelib}/aliyun_python_sdk_slb-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkslb
%{python3_sitelib}/aliyun_python_sdk_slb-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 3.2.16-1
- Initial package.