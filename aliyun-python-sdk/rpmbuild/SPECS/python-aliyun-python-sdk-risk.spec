...
%global pypi_name aliyun-python-sdk-risk
...
%description
aliyun-python-sdk-risk This is the risk module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkrisk
%{python2_sitelib}/aliyun_python_sdk_risk-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkrisk
%{python3_sitelib}/aliyun_python_sdk_risk-%{version}-py?.?.egg-info
