...
%global pypi_name aliyun-python-sdk-ubsms
...
%description
aliyun-python-sdk-ubsms This is the ubsms module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkubsms
%{python2_sitelib}/aliyun_python_sdk_ubsms-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkubsms
%{python3_sitelib}/aliyun_python_sdk_ubsms-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 2.0.5-1
- Initial package.