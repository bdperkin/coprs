...
%global pypi_name aliyun-python-sdk-sts
...
%description
aliyun-python-sdk-sts This is the sts module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdksts
%{python2_sitelib}/aliyun_python_sdk_sts-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdksts
%{python3_sitelib}/aliyun_python_sdk_sts-%{version}-py?.?.egg-info
