...
%global pypi_name aliyun-python-sdk-dts
...
%description
 aliyun-python-sdk-dts .. This is the dts module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkdts
%{python2_sitelib}/aliyun_python_sdk_dts-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkdts
%{python3_sitelib}/aliyun_python_sdk_dts-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 5.0.26.19.1-1
- Initial package.