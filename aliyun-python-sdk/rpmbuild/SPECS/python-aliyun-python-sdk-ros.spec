...
%global pypi_name aliyun-python-sdk-ros
...
%description
 aliyun-python-sdk-ros .. This is the ros module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkros
%{python2_sitelib}/aliyun_python_sdk_ros-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkros
%{python3_sitelib}/aliyun_python_sdk_ros-%{version}-py?.?.egg-info
