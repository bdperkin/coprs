...
%global pypi_name aliyun-python-sdk-iot
...
%description
 aliyun-python-sdk-iot .. This is the iot module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkiot
%{python2_sitelib}/aliyun_python_sdk_iot-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkiot
%{python3_sitelib}/aliyun_python_sdk_iot-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 8.5.0-1
- Initial package.