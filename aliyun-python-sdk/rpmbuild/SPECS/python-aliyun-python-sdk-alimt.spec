...
%global pypi_name aliyun-python-sdk-alimt
...
%description
aliyun-python-sdk-alimt This is the alimt module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkalimt
%{python2_sitelib}/aliyun_python_sdk_alimt-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkalimt
%{python3_sitelib}/aliyun_python_sdk_alimt-%{version}-py?.?.egg-info
