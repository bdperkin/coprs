...
%global pypi_name aliyun-python-sdk-afs

Name:           python-%{pypi_name}
Version:        1.0.1
Release:        1%{?dist}
Summary:        The afs module of Aliyun Python sdk
...
%description
aliyun-python-sdk-afs This is the afs module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkafs
%{python2_sitelib}/aliyun_python_sdk_afs-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkafs
%{python3_sitelib}/aliyun_python_sdk_afs-%{version}-py?.?.egg-info
