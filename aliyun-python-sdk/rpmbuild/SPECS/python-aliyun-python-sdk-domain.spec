...
%global pypi_name aliyun-python-sdk-domain
...
%description
 aliyun-python-sdk-domain .. This is the domain module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkdomain
%{python2_sitelib}/aliyun_python_sdk_domain-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkdomain
%{python3_sitelib}/aliyun_python_sdk_domain-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 3.14.2-1
- Initial package.