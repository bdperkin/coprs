...
%global pypi_name aliyun-python-sdk-emr

Name:           python-%{pypi_name}
Version:        3.2.5
Release:        1%{?dist}
Summary:        The emr module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-emr .. This is the emr module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkemr
%{python2_sitelib}/aliyun_python_sdk_emr-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkemr
%{python3_sitelib}/aliyun_python_sdk_emr-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 3.2.5-1
- Initial package.