...
%global pypi_name aliyun-python-sdk-polardb
...
%description
 aliyun-python-sdk-polardb .. This is the polardb module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkpolardb
%{python2_sitelib}/aliyun_python_sdk_polardb-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkpolardb
%{python3_sitelib}/aliyun_python_sdk_polardb-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 1.6.8-1
- Initial package.