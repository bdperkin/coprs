...
%global pypi_name aliyun-python-sdk-pvtz

Name:           python-%{pypi_name}
Version:        1.0.4
Release:        1%{?dist}
Summary:        The pvtz module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-pvtz .. This is the pvtz module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkpvtz
%{python2_sitelib}/aliyun_python_sdk_pvtz-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkpvtz
%{python3_sitelib}/aliyun_python_sdk_pvtz-%{version}-py?.?.egg-info
