...
%global pypi_name aliyun-python-sdk-visionai

Name:           python-%{pypi_name}
Version:        1.0.1
Release:        1%{?dist}
Summary:        The visionai module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-visionai .. This is the visionai module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkvisionai
%{python2_sitelib}/aliyun_python_sdk_visionai-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkvisionai
%{python3_sitelib}/aliyun_python_sdk_visionai-%{version}-py?.?.egg-info
