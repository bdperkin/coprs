...
%global pypi_name aliyun-python-sdk-ram
...
%description
aliyun-python-sdk-ram This is the ram module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkram
%{python2_sitelib}/aliyun_python_sdk_ram-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkram
%{python3_sitelib}/aliyun_python_sdk_ram-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 3.1.0-1
- Initial package.