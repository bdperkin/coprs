...
%global pypi_name aliyun-python-sdk-fnf

Name:           python-%{pypi_name}
Version:        1.4.0
Release:        1%{?dist}
Summary:        The fnf module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-fnf .. This is the fnf module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkfnf
%{python2_sitelib}/aliyun_python_sdk_fnf-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkfnf
%{python3_sitelib}/aliyun_python_sdk_fnf-%{version}-py?.?.egg-info
