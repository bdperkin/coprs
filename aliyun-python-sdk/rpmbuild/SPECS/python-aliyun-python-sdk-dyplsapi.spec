...
%global pypi_name aliyun-python-sdk-dyplsapi
...
%description
 aliyun-python-sdk-dyplsapi .. This is the dyplsapi module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkdyplsapi
%{python2_sitelib}/aliyun_python_sdk_dyplsapi-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkdyplsapi
%{python3_sitelib}/aliyun_python_sdk_dyplsapi-%{version}-py?.?.egg-info
