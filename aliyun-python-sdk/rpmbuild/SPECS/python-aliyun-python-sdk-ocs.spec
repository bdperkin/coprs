...
%global pypi_name aliyun-python-sdk-ocs
...
%description
aliyun-python-sdk-ocs This is the ocs module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkocs
%{python2_sitelib}/aliyun_python_sdk_ocs-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkocs
%{python3_sitelib}/aliyun_python_sdk_ocs-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 0.0.4-1
- Initial package.