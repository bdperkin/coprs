...
%global pypi_name aliyun-python-sdk-scdn

Name:           python-%{pypi_name}
Version:        2.0.0
Release:        1%{?dist}
Summary:        The scdn module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-scdn .. This is the scdn module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkscdn
%{python2_sitelib}/aliyun_python_sdk_scdn-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkscdn
%{python3_sitelib}/aliyun_python_sdk_scdn-%{version}-py?.?.egg-info
