...
%global pypi_name aliyun-python-sdk-smc

Name:           python-%{pypi_name}
Version:        1.0.1
Release:        1%{?dist}
Summary:        The smc module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-smc .. This is the smc module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdksmc
%{python2_sitelib}/aliyun_python_sdk_smc-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdksmc
%{python3_sitelib}/aliyun_python_sdk_smc-%{version}-py?.?.egg-info
