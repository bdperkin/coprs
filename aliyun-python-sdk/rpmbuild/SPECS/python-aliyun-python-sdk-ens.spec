...
%global pypi_name aliyun-python-sdk-ens
...
%description
 aliyun-python-sdk-ens .. This is the ens module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkens
%{python2_sitelib}/aliyun_python_sdk_ens-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkens
%{python3_sitelib}/aliyun_python_sdk_ens-%{version}-py?.?.egg-info
