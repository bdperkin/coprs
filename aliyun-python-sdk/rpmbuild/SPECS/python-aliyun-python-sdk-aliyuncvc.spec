...
%global pypi_name aliyun-python-sdk-aliyuncvc

Name:           python-%{pypi_name}
Version:        1.0.1
Release:        1%{?dist}
Summary:        The aliyuncvc module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-aliyuncvc .. This is the aliyuncvc module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkaliyuncvc
%{python2_sitelib}/aliyun_python_sdk_aliyuncvc-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkaliyuncvc
%{python3_sitelib}/aliyun_python_sdk_aliyuncvc-%{version}-py?.?.egg-info
