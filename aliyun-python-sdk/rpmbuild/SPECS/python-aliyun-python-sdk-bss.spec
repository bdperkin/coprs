...
%global pypi_name aliyun-python-sdk-bss
...
%description
aliyun-python-sdk-bss This is the bss module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkbss
%{python2_sitelib}/aliyun_python_sdk_bss-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkbss
%{python3_sitelib}/aliyun_python_sdk_bss-%{version}-py?.?.egg-info
