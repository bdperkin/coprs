...
%global pypi_name aliyun-python-sdk-kms
...
%description
 aliyun-python-sdk-kms .. This is the kms module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkkms
%{python2_sitelib}/aliyun_python_sdk_kms-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkkms
%{python3_sitelib}/aliyun_python_sdk_kms-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 2.9.0-1
- Initial package.