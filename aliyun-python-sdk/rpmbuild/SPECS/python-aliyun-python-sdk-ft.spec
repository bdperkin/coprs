...
%global pypi_name aliyun-python-sdk-ft
...
%description
aliyun-python-sdk-ft This is the ft module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkft
%{python2_sitelib}/aliyun_python_sdk_ft-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkft
%{python3_sitelib}/aliyun_python_sdk_ft-%{version}-py?.?.egg-info
