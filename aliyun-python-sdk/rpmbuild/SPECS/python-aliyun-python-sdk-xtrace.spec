...
%global pypi_name aliyun-python-sdk-xtrace

Name:           python-%{pypi_name}
Version:        0.1.1
Release:        1%{?dist}
Summary:        The xtrace module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-xtrace .. This is the xtrace module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkxtrace
%{python2_sitelib}/aliyun_python_sdk_xtrace-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkxtrace
%{python3_sitelib}/aliyun_python_sdk_xtrace-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 0.1.1-1
- Initial package.