...
%global pypi_name aliyun-python-sdk-facebody
...
%description
 aliyun-python-sdk-facebody .. This is the facebody module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkfacebody
%{python2_sitelib}/aliyun_python_sdk_facebody-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkfacebody
%{python3_sitelib}/aliyun_python_sdk_facebody-%{version}-py?.?.egg-info
