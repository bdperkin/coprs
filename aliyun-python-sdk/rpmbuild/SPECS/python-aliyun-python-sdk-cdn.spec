...
%global pypi_name aliyun-python-sdk-cdn
...
%description
 aliyun-python-sdk-cdn .. This is the cdn module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkcdn
%{python2_sitelib}/aliyun_python_sdk_cdn-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkcdn
%{python3_sitelib}/aliyun_python_sdk_cdn-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 3.3.0-1
- Initial package.