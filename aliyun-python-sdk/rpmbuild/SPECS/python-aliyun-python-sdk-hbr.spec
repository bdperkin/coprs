...
%global pypi_name aliyun-python-sdk-hbr

Name:           python-%{pypi_name}
Version:        0.0.1
Release:        1%{?dist}
Summary:        The hbr module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-hbr .. This is the hbr module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkhbr
%{python2_sitelib}/aliyun_python_sdk_hbr-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkhbr
%{python3_sitelib}/aliyun_python_sdk_hbr-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 0.0.1-1
- Initial package.