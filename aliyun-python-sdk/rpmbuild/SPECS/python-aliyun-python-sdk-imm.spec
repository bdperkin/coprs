...
%global pypi_name aliyun-python-sdk-imm
...
%description
 aliyun-python-sdk-imm .. This is the imm module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkimm
%{python2_sitelib}/aliyun_python_sdk_imm-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkimm
%{python3_sitelib}/aliyun_python_sdk_imm-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 1.15.7-1
- Initial package.