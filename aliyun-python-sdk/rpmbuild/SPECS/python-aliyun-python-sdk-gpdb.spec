...
%global pypi_name aliyun-python-sdk-gpdb
...
%description
aliyun-python-sdk-gpdb This is the gpdb module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkgpdb
%{python2_sitelib}/aliyun_python_sdk_gpdb-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkgpdb
%{python3_sitelib}/aliyun_python_sdk_gpdb-%{version}-py?.?.egg-info
