...
%global pypi_name aliyun-python-sdk-pts

Name:           python-%{pypi_name}
Version:        2.0.1
Release:        1%{?dist}
Summary:        The pts module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-pts .. This is the pts module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkpts
%{python2_sitelib}/aliyun_python_sdk_pts-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkpts
%{python3_sitelib}/aliyun_python_sdk_pts-%{version}-py?.?.egg-info
