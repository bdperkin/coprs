...
%global pypi_name aliyun-python-sdk-dds
...
%description
 aliyun-python-sdk-dds .. This is the dds module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkdds
%{python2_sitelib}/aliyun_python_sdk_dds-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkdds
%{python3_sitelib}/aliyun_python_sdk_dds-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 2.0.7-1
- Initial package.