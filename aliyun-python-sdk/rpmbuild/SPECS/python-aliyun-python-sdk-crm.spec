...
%global pypi_name aliyun-python-sdk-crm
...
%description
aliyun-python-sdk-crm This is the crm module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkcrm
%{python2_sitelib}/aliyun_python_sdk_crm-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkcrm
%{python3_sitelib}/aliyun_python_sdk_crm-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 2.2.1-1
- Initial package.