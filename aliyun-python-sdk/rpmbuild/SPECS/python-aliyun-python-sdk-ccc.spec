...
%global pypi_name aliyun-python-sdk-ccc
...
%description
 aliyun-python-sdk-ccc .. This is the ccc module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkccc
%{python2_sitelib}/aliyun_python_sdk_ccc-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkccc
%{python3_sitelib}/aliyun_python_sdk_ccc-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 1.0.19-1
- Initial package.