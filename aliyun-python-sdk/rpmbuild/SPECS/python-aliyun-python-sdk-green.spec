...
%global pypi_name aliyun-python-sdk-green

Name:           python-%{pypi_name}
Version:        3.5.1
Release:        1%{?dist}
Summary:        The green module of Aliyun Python sdk
...
%description
 aliyun-python-sdk-green .. This is the green module of Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkgreen
%{python2_sitelib}/aliyun_python_sdk_green-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkgreen
%{python3_sitelib}/aliyun_python_sdk_green-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 3.5.1-1
- Initial package.