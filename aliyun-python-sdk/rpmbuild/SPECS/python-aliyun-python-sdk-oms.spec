...
%global pypi_name aliyun-python-sdk-oms
...
%description
aliyun-python-sdk-oms This is the oms module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkoms
%{python2_sitelib}/aliyun_python_sdk_oms-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkoms
%{python3_sitelib}/aliyun_python_sdk_oms-%{version}-py?.?.egg-info
