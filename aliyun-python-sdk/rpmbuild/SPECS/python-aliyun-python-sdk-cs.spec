...
%global pypi_name aliyun-python-sdk-cs
...
%description
aliyun-python-sdk-cs This is the cs module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkcs
%{python2_sitelib}/aliyun_python_sdk_cs-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkcs
%{python3_sitelib}/aliyun_python_sdk_cs-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 4.7.14-1
- Initial package.