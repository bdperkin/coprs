...
%global pypi_name aliyun-python-sdk-arms
...
%description
 aliyun-python-sdk-arms .. This is the arms module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkarms
%{python2_sitelib}/aliyun_python_sdk_arms-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkarms
%{python3_sitelib}/aliyun_python_sdk_arms-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 2.5.2-1
- Initial package.