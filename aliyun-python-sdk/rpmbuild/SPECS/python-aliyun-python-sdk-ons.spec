...
%global pypi_name aliyun-python-sdk-ons
...
%description
 aliyun-python-sdk-ons .. This is the ons module of Aliyun Python SDK.Aliyun
...
%doc README.rst
%{python2_sitelib}/aliyunsdkons
%{python2_sitelib}/aliyun_python_sdk_ons-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkons
%{python3_sitelib}/aliyun_python_sdk_ons-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 3.1.3-1
- Initial package.