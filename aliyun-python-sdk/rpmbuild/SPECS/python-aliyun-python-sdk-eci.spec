...
%global pypi_name aliyun-python-sdk-eci
...
%description
aliyun-python-sdk-eci This is the eci module of Aliyun Python SDK.Aliyun Python
...
%doc README.rst
%{python2_sitelib}/aliyunsdkeci
%{python2_sitelib}/aliyun_python_sdk_eci-%{version}-py?.?.egg-info

%files -n python3-%{pypi_name}
%doc README.rst
%{python3_sitelib}/aliyunsdkeci
%{python3_sitelib}/aliyun_python_sdk_eci-%{version}-py?.?.egg-info

%changelog
* Thu Feb 20 2020 mockbuilder - 1.0.8-1
- Initial package.